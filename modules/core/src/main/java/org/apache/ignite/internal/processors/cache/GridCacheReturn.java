...
public class GridCacheReturn implements Message {
    /**
     * Delegate for {@code CacheObject} marshal/unmarshal traversal (generated by APT).
     *
     * FIXME IGNITE-28520 Phase 2: remove this field together with {@link #prepareMarshal(GridCacheContext)} and
     * {@link #finishUnmarshal(GridCacheContext, ClassLoader)} once the communication framework invokes
     * {@code MessageSerializer#prepareMarshalCacheObjects} / {@code MessageSerializer#finishUnmarshalCacheObjects}
     * directly on the user thread (before NIO handoff on send, after demarshal on receive). Until then we delegate
     * {@code CacheObject} traversal to the generated serializer to avoid duplicating logic, accepting a transient
     * source &rarr; generated-source dependency.
     */
     ...
     *
     * FIXME IGNITE-28520 Phase 2: drop this method once the communication layer calls
     * {@link GridCacheReturnSerializer#prepareMarshalCacheObjects} automatically on the user thread.
     */
